...
The file Wind_Turbine_Project_Code.ipynb contains all of the code to run the 3 algorithims (RF, SVR, RNN) and the plots of their results. Each section is labeled with a different header and their are text descriptions / comments explaining each step. Once the dataframe is loaded, any of the algrothims can be run independently of the others. 
